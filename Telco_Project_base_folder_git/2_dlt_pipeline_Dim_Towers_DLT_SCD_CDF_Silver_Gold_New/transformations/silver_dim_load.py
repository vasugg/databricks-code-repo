...
def load_tower_silver():
    ...
    raw_stream = spark.readStream.option("ignoreDeletes", "true").table("telecom_bronze.bronze_dim_tower")
    #raw_stream = spark.readStream.table("azdatabricksde0526.telecom_bronze.bronze_dim_tower")
